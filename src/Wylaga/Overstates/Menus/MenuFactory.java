...
public class MenuFactory
{
    ...
    public static Menu makeMainMenu(ButtonFunction startGameFunction)
    {
        ...
        mainMenu.addDisplay(new SimpleDisplayable(new Point(590, 650), ImageFactory.getSmallBasePlayerImage()));
        mainMenu.addDisplay(new SimpleDisplayable(new Point(665, 650), ImageFactory.getSmallBasePlayerImage()));
        mainMenu.addDisplay(new SimpleDisplayable(new Point(615, 600), ImageFactory.getBasePlayerImage()));
    ...
    public static Menu makeStartMenu(AbstractFunction initialFunction)
    {
        ...
        startMenu.addDisplay(new SimpleDisplayable(new Point(590, 650), ImageFactory.getSmallBasePlayerImage()));
        startMenu.addDisplay(new SimpleDisplayable(new Point(665, 650), ImageFactory.getSmallBasePlayerImage()));
        startMenu.addDisplay(new SimpleDisplayable(new Point(615, 600), ImageFactory.getBasePlayerImage()));
        return startMenu;
    }
}
